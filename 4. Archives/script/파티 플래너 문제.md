...
$R(3, 3) = 6$이라는 결론은 비교적 간단하게 나왔지만, 만약 $R(4,~3)$은 어떨까요? 가장 편한 


$R(4, 4)=17$이므로 훨씬 큰 수입니다. 한명의 사람만 추가해도 결과는 기하급수적으로 증가합니다. 이 문제의 복잡성은 예측하기 어렵고, 컴퓨터를 이용한 계산조차 어려운 경우가 많습니다.
